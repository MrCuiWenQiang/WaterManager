$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '微信用户唯一标识', name: 'openId', index: 'open_id', width: 80 }, 			
			{ label: '手机号', name: 'mobile', index: 'mobile', width: 80 }, 			
			{ label: '用户名', name: 'username', index: 'username', width: 80 }, 			
			{ label: '密码', name: 'password', index: 'password', width: 80 }, 			
			{ label: '盐', name: 'salt', index: 'salt', width: 80 }, 			
			{ label: '用户状态:0:停用 1:正常', name: 'status', index: 'status', width: 80 }, 			
			{ label: '普通用户性别，1为男性，2为女性', name: 'sex', index: 'sex', width: 80 }, 			
			...
			{ label: '创造时间', name: 'createTimer', index: 'create_timer', width: 80 }			
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
